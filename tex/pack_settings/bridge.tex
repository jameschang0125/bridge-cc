\lstdefinelanguage{BridgeSeq}{
  morecomment=[l]\#,
  moredelim=**[il][\bfseries\color{ListingEmph}]{!},
  moredelim=**[il][\color{ListingLineEmph}]{^},
}
\newcommand\bin[1]{
\lstinputlisting[language=BridgeSeq,label={#1}]{#1}
}
\usepackage{xcolor}
...
% \usepackage{colortbl} % loaded via xcolor in color.tex
...
\definecolor{ListingEmph}{HTML}{000FFF}
\definecolor{ListingLineEmph}{HTML}{0A4BA1}
...
% Short helpers for colored emphasis inside listings via <@ ... @>.
\NewDocumentCommand{\bb}{O{ListingEmph} m}{\textbf{\textcolor{#1}{#2}}}
\NewDocumentCommand{\br}{m}{\bb[red]{#1}}
