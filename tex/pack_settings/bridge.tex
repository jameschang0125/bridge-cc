...
\newlength{\bidLeftWidth}\setlength{\bidLeftWidth}{.50\textwidth}
\newlength{\bidRightWidth}\setlength{\bidRightWidth}{.50\textwidth}
...
\else
  \def\bidLeftCell{}%
\fi
{\cellcolor{\bidGroupFillSpecLeft}\bidLeftCell} & {\cellcolor{\bidGroupFillSpec}\ttfamily{\color{subbidTextColor}\phantom{oo}#1}\IfValueT{#2}{{\texttt{\color{subbidTextColor}:}\ \texttt{\color{subbidExtraColor} #2}}}}\tabularnewline
}
