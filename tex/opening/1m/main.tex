...
second, rebidding \texttt{3m} after Gazzilli becomes game-forcing (18+);
...
However, to address the issue of bal and unbal raise, we make \texttt{1C - 1DH; 2D} an artificial raise, showing a min bal 4M fit.
...
Rebidding \texttt{2m \& 2M} is weak (as described previously). For others, see conventions/non-comp/Gazilli accepted.
% TODO: reference
